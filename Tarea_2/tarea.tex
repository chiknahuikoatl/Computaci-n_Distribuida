...
\begin{enumerate}
		...
		más	barras de uranio para que la planta pueda seguir trabajando, así que llama
		a la Dra. Benitez para comprarle el uranio que produce en su laboratorio. El 
		problema es que si envía.
